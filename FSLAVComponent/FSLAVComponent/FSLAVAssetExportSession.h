...
@class FSLAVAssetExportSession;

@protocol FSLAVAssetExportSessionDelegate <NSObject>
@optional
...
/**
 用可定制的音频和视频设置替换AVAssetExportSession。
 重写AVAssetExportSession达到可以预设置的目的
 */
@interface FSLAVAssetExportSession : NSObject

@property (nonatomic, weak) id<FSLAVAssetExportSessionDelegate> delegate;
